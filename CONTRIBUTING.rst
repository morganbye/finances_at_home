...
finances_at_home could always use more documentation, whether as part of the
official finances_at_home docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `finances_at_home` for local development.
...
$ py.test tests.test_finances_at_home
